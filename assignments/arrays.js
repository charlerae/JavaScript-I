...
//     if(inventory.id === 33) {
//         recall = `Car 33 is a ${inentory.carYears} ${inventory.car_make} ${inventory.car_model}`
...
console.log(`Car 33 is ${car33.car_year}, ${car33.car_make}, ${car33.car_model}.`);
...
console.log('The Last Car put into inventory was id #' + lastCar.id + ' ' + lastCar.car_make + ', ' + lastCar.car_model);
